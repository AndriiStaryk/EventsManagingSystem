...
public class LocationsController : Controller
{
    ...
    public async Task<IActionResult> Create([Bind("Id,Name,Address,Description,Latitude,Longitude")] Location location)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,Description,Latitude,Longitude")] Location location)
    {
        if (id != location.Id)
        {
            return NotFound();
